mixdata = importdata('Heuristic_mixdata.txt');
...
% first_half = mixdata(1:122,1:270);
% second_half = mixdata(123:244,1:270);
...
first_half_44 = mixdata(1:122,1:44);
second_half_44 = mixdata(123:244,1:44);

heatmap(minus(first_half_44,second_half_44));
